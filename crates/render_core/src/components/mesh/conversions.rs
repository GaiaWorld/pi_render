...
//!
//! ```
//! use pi_render::mesh::VertexAttributeValues;
//!
//! // creating std::vec::Vec
//! let buffer = vec![[0_u32; 4]; 10];
//!
//! // converting std::vec::Vec to pi_render::mesh::VertexAttributeValues
//! let values = VertexAttributeValues::from(buffer.clone());
//!
//! // converting pi_render::mesh::VertexAttributeValues to std::vec::Vec with two ways
...
use render_utils::EnumVariantMeta;
use thiserror::Error;
