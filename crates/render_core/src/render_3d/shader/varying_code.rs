...
impl From<&crate::rhi::shader::ShaderVarying> for Varyings {
    fn from(value: &crate::rhi::shader::ShaderVarying) -> Self {
...
mod test {
    ...
    use crate::render_3d::shader::varying_code::{VaryingCode, Varyings, Varying};
