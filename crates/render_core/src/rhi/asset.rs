	...
	fn async_load(desc: ImageTextureDesc<'a>, result: LoadResult<'a, Self, G>) -> BoxFuture<'a, std::io::Result<Handle<Self>>> {
		Box::pin(async move { 
			match result {
				...
				LoadResult::Wait(f) => f.await,
				LoadResult::Receiver(recv) => {
					let texture = if desc.url.ends_with(KTX_SUFF) {
						// // 加载ktx
						...
						create_texture_from_image(&image, &desc.device, &desc.queue, &desc.url, recv).await
					};
...
// 		wgpu::ImageDataLayout {
// 			offset: 0,
// 			bytes_per_row: Some(std::num::NonZeroU32::new(decoder.read_textures()).unwrap()),
// 			rows_per_image: None,
// 		},
// 		texture_extent,
// 	);
...
// 		0x8c00 => wgpu::TextureFormat::Astc { block: AstcBlock::B4x4, channel: AstcChannel::Unorm },// GL_COMPRESSED_RGB_PVRTC_4BPPV1_IMG	0x8c00 GL_COMPRESSED_RGBA_ASTC_4x4_KHR	Astc4x4Unorm
// 		0x8c01 => wgpu::TextureFormat::Astc { block: AstcBlock::B5x4, channel: AstcChannel::Unorm },// GL_COMPRESSED_RGB_PVRTC_2BPPV1_IMG	0x8c01 GL_COMPRESSED_RGBA_ASTC_5x4_KHR	Astc5x4Unorm
// 		0x8c02 => wgpu::TextureFormat::Astc { block: AstcBlock::B5x5, channel: AstcChannel::Unorm },// GL_COMPRESSED_RGBA_PVRTC_4BPPV1_IMG	0x8c02 GL_COMPRESSED_RGBA_ASTC_5x5_KHR	Astc5x5Unorm
// 		0x8c03 => wgpu::TextureFormat::Astc { block: AstcBlock::B6x5, channel: AstcChannel::Unorm },// GL_COMPRESSED_RGBA_PVRTC_2BPPV1_IMG	0x8c03 GL_COMPRESSED_RGBA_ASTC_6x5_KHR	Astc6x5Unorm
// 		0x93b0 => wgpu::TextureFormat::Astc { block: AstcBlock::B6x6, channel: AstcChannel::Unorm },// GL_COMPRESSED_RGBA_ASTC_4x4_KHR	0x93b0     GL_COMPRESSED_RGBA_ASTC_6x6_KHR	Astc6x6Unorm
// 		0x93b1 => wgpu::TextureFormat::Astc { block: AstcBlock::B8x5, channel: AstcChannel::Unorm },// GL_COMPRESSED_RGBA_ASTC_5x4_KHR	0x93b1     GL_COMPRESSED_RGBA_ASTC_8x5_KHR	Astc8x5Unorm
// 		0x93b2 => wgpu::TextureFormat::Astc { block: AstcBlock::B8x6, channel: AstcChannel::Unorm },// GL_COMPRESSED_RGBA_ASTC_5x5_KHR	0x93b2     GL_COMPRESSED_RGBA_ASTC_8x6_KHR	Astc8x6Unorm
// 		0x93b3 => wgpu::TextureFormat::Astc { block: AstcBlock::B8x8, channel: AstcChannel::Unorm },// GL_COMPRESSED_RGBA_ASTC_6x5_KHR	0x93b3     GL_COMPRESSED_RGBA_ASTC_8x8_KHR	Astc8x8Unorm
// 		0x93b4 => wgpu::TextureFormat::Astc { block: AstcBlock::B10x5, channel: AstcChannel::Unorm },// GL_COMPRESSED_RGBA_ASTC_6x6_KHR	0x93b4     GL_COMPRESSED_RGBA_ASTC_10x5_KHR	Astc10x5Unorm
// 		0x93b5 => wgpu::TextureFormat::Astc { block: AstcBlock::B10x6, channel: AstcChannel::Unorm },// GL_COMPRESSED_RGBA_ASTC_8x5_KHR	0x93b5     GL_COMPRESSED_RGBA_ASTC_10x6_KHR	Astc10x6Unorm
// 		0x93b6 => wgpu::TextureFormat::Astc { block: AstcBlock::B10x8, channel: AstcChannel::Unorm },// GL_COMPRESSED_RGBA_ASTC_8x6_KHR	0x93b6     GL_COMPRESSED_RGBA_ASTC_10x8_KHR	Astc10x8Unorm
// 		0x93b7 => wgpu::TextureFormat::Astc { block: AstcBlock::B10x10, channel: AstcChannel::Unorm },// GL_COMPRESSED_RGBA_ASTC_8x8_KHR	0x93b7     GL_COMPRESSED_RGBA_ASTC_10x10_KHR	Astc10x10Unorm
// 		0x93b8 => wgpu::TextureFormat::Astc { block: AstcBlock::B12x10, channel: AstcChannel::Unorm },// GL_COMPRESSED_RGBA_ASTC_10x5_KHR	0x93b8     GL_COMPRESSED_RGBA_ASTC_12x10_KHR	Astc12x10Unorm
// 		0x93b9 => wgpu::TextureFormat::Astc { block: AstcBlock::B12x12, channel: AstcChannel::Unorm },// GL_COMPRESSED_RGBA_ASTC_10x6_KHR	0x93b9     GL_COMPRESSED_RGBA_ASTC_12x12_KHR	Astc12x12Unorm
// 		// 0x93ba => wgpu::TextureFormat::PvrtcRgb4bppUnorm,// GL_COMPRESSED_RGBA_ASTC_10x8_KHR	0x93ba     GL_COMPRESSED_RGB_PVRTC_4BPPV1_IMG	PvrtcRgb4bppUnorm
// 		// 0x93bb => wgpu::TextureFormat::Bc1RgbUnorm,// GL_COMPRESSED_RGBA_ASTC_10x10_KHR	0x93bb     GL_COMPRESSED_RGB_PVRTC_2BPPV1_IMG	PvrtcRgb2bppUnorm
// 		// 0x93bc => wgpu::TextureFormat::Bc1RgbUnorm,// GL_COMPRESSED_RGBA_ASTC_12x10_KHR	0x93bc     GL_COMPRESSED_RGBA_PVRTC_4BPPV1_IMG	PvrtcRgba4bppUnorm
// 		// 0x93bd => wgpu::TextureFormat::Bc1RgbUnorm,// GL_COMPRESSED_RGBA_ASTC_12x12_KHR	0x93bd     GL_COMPRESSED_RGBA_PVRTC_2BPPV1_IMG	PvrtcRgba2bppUnorm
