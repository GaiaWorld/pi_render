...
impl TVertexFormatCode for wgpu::VertexFormat {
    fn vs_code(&self) -> String {
        match self {
            ...
            wgpu::VertexFormat::Uint32x2    => String::from(""),
            wgpu::VertexFormat::Uint32x3    => String::from(""),
            wgpu::VertexFormat::Uint32x4    => String::from(""),
            wgpu::VertexFormat::Sint32      => String::from("int"),
            wgpu::VertexFormat::Sint32x2    => String::from(""),
            wgpu::VertexFormat::Sint32x3    => String::from(""),
            wgpu::VertexFormat::Sint32x4    => String::from(""),
