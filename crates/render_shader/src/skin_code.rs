...
use crate::{unifrom_code::{UniformTextureDesc, UniformPropertyName, UniformSamplerDesc}, set_bind::ShaderSetBind, buildin_var::ShaderVarUniform, buildin_data::EDefaultTexture};
...
impl ESkinCode {
    ...
    pub fn uniform_desc_tex() -> UniformTextureDesc {
